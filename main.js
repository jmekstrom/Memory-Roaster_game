   ...
   $(document).ready(function(){
	...
	function card_click(card_back_id,card_front_id){
    	...
    	if(click_num == 1){
        	...
        	if(card_front_src == first_clicked_card_src){
                ...
                card_match(first_clicked_card_front_id,second_clicked_card_front_id);
	...
	function flip_cards(){
        ...
        console.log(speed,cards_matched);

		setTimeout(function(){$(first_clicked_card_id).animate({top: '0px'});$(second_clicked_card_id).animate({top: '0px'});click_num=0;console.log("Card flipping re-enabled");},speed); 
    ...
    function game_won(){
        setTimeout(function(){console.log('Game Won!!!!');set_random_images();$(".game_area").hide();$(".game_won").show()},3000);
    ...
    function card_match(first_clicked_card_id,second_clicked_card_id){
        console.log("Card Match!!!");
        click_num = 0;
        console.log("Card flipping re-enabled")
        cards_matched = cards_matched + 1;
        var card_to_highlight1= "."+first_clicked_card_front_id.substr(1, first_clicked_card_front_id.length-1);
        console.log(card_to_highlight1);
        var card_to_highlight2= "."+second_clicked_card_front_id.substr(1, second_clicked_card_front_id.length-1);
        console.log(card_to_highlight2);
        $(card_to_highlight1).css("border-color","#00FF00");
        $(card_to_highlight2).css("border-color","#00FF00");
